...
public class ShardingJdbcConfig {
    ...
    public DataSource shardingDataSource(DruidDataSource druidDataSource) {
        ...
        KeyGeneratorConfiguration keyGeneratorConfiguration = new KeyGeneratorConfiguration("MY", "order_id");
        ...
        // 分表策略
        orderTableRuleConfig.setTableShardingStrategyConfig((new ComplexShardingStrategyConfiguration("order_id",
                new OrderShardingAlgorithm())));
